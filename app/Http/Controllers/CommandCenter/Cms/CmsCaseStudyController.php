...
class CmsCaseStudyController extends Controller
{
    ...
    public function create(Request $request): View { return view('command-center.cms.case-studies.create', ['study' => null, 'media' => CmsMedia::query()->where('company_id', $request->user()->company_id)->orderBy('filename')->get()]); }
    ...
    public function edit(Request $request, CmsCaseStudyRepository $studies, int $caseStudy): View { return view('command-center.cms.case-studies.edit', ['study' => $studies->findForCompany($request->user()->company_id, $caseStudy), 'media' => CmsMedia::query()->where('company_id', $request->user()->company_id)->orderBy('filename')->get()]); }
