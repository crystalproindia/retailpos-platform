...
class InvoiceController extends Controller
{
    ...
    public function show(Request $request, InvoiceRepository $invoices, InvoiceService $service, int $invoice): View { $record = $service->refreshStatus($invoices->find($request->user(), $invoice)); return view('command-center.crm.invoices.show', ['invoice' => $record->load(['items', 'payments.recorder', 'quotation', 'lead', 'latestInvoiceEmailDelivery'])]); }
