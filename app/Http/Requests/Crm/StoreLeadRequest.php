...
class StoreLeadRequest extends FormRequest
{
    ...
    protected function leadRules(): array
    {
        ...
        return [
            ...
            'source_id' => ['nullable', Rule::exists('crm_lead_sources', 'id')->where('company_id', $companyId)->where('is_active', true)],
            'status_id' => ['required', Rule::exists('crm_lead_statuses', 'id')->where('company_id', $companyId)->where('is_active', true)],
            ...
            'lead_creation_token' => ['nullable', 'uuid'],
            'client_receptiveness_rating' => ['nullable', 'integer', 'min:1', 'max:5'],
            'buying_interest_rating' => ['nullable', 'integer', 'min:1', 'max:5'],
            'follow_up_urgency_rating' => ['nullable', 'integer', 'min:1', 'max:5'],
