...
#[Fillable(['company_id', 'client_logo_media_id', 'featured_image_media_id', 'og_image_media_id', 'title', 'slug', 'client_name', 'industry', 'location', 'project_type', 'short_summary', 'challenge', 'solution', 'key_features', 'results', 'metrics', 'testimonial_quote', 'gallery_media_ids', 'related_product', 'related_module', 'related_industry', 'cta_text', 'cta_link', 'status', 'is_featured', 'sort_order', 'seo_title', 'seo_description', 'published_at'])]
class CmsCaseStudy extends Model
{
    use Auditable, SoftDeletes;
    protected function casts(): array { return ['metrics' => 'array', 'gallery_media_ids' => 'array', 'is_featured' => 'boolean', 'published_at' => 'datetime']; }
