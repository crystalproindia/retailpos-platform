...
#[Fillable(['invoice_id', 'amendment_id', 'product_id', 'category_id_snapshot', 'brand_id_snapshot', 'name', 'sku_snapshot', 'category_name_snapshot', 'brand_name_snapshot', 'description', 'hsn_sac', 'quantity', 'unit', 'unit_price', 'unit_cost_snapshot', 'total_cost_snapshot', 'gross_sales_snapshot', 'net_sales_snapshot', 'gross_profit_before_discount', 'gross_profit_snapshot', 'gross_margin_percent_snapshot', 'cost_snapshot_method', 'cost_snapshot_status', 'discount_type', 'discount_value', 'discount_amount', 'tax_rate', 'tax_treatment_snapshot', 'tax_amount', 'cgst_amount', 'sgst_amount', 'igst_amount', 'cess_amount', 'line_subtotal', 'line_total', 'sort_order'])]
