...
#[Fillable(['company_id', 'branch_id', 'invoice_id', 'payment_reference', 'amount', 'currency', 'payment_date', 'payment_method', 'transaction_reference', 'bank_name', 'cheque_number', 'notes', 'status', 'receipt_number', 'recorded_by', 'cleared_by', 'cleared_at', 'reversed_by', 'reversed_at', 'reversal_reason', 'idempotency_key'])]
