...
#[Fillable(['company_id', 'branch_id', 'crm_company_id', 'crm_contact_id', 'source_id', 'status_id', 'assigned_user_id', 'created_by', 'title', 'business_name', 'contact_name', 'email', 'phone', 'alternate_phone', 'industry', 'interested_modules', 'expected_value', 'currency', 'priority', 'lead_score', 'next_follow_up_at', 'last_contacted_at', 'lost_reason', 'description', 'converted_at'])]
