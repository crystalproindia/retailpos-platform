...
#[Fillable(['company_id', 'lead_id', 'assigned_to', 'scheduled_by', 'title', 'scheduled_date', 'starts_at', 'ends_at', 'timezone', 'meeting_mode', 'meeting_link', 'customer_email', 'customer_phone', 'notes', 'status', 'completed_at', 'cancelled_at'])]
