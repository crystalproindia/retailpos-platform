...
#[Fillable(['company_id', 'branch_id', 'customer_id', 'sale_number', 'status', 'subtotal', 'discount_amount', 'tax_amount', 'total_amount', 'paid_amount', 'change_amount', 'notes', 'device_type', 'held_by', 'completed_by', 'held_at', 'completed_at'])]
class PosSale extends Model
{
    ...
    {
        return ['subtotal' => 'decimal:2', 'discount_amount' => 'decimal:2', 'tax_amount' => 'decimal:2', 'total_amount' => 'decimal:2', 'paid_amount' => 'decimal:2', 'change_amount' => 'decimal:2', 'held_at' => 'datetime', 'completed_at' => 'datetime'];
    }
