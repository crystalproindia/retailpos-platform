...
#[Fillable(['company_id', 'po_prefix', 'pr_prefix', 'grn_prefix', 'return_prefix', 'invoice_prefix', 'payment_prefix', 'next_po_number', 'next_pr_number', 'next_grn_number', 'next_return_number', 'next_invoice_number', 'next_payment_number', 'require_po_approval', 'require_purchase_request_approval', 'require_return_approval', 'default_payment_terms', 'default_tax_inclusive', 'allow_receive_without_po', 'auto_create_pr_from_reorder'])]
