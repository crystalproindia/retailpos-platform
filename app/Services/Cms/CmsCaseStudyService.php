...
class CmsCaseStudyService
{
    ...
    /** @return array<string, mixed> */ private function snapshot(CmsCaseStudy $study): array { return $study->load('sections')->only(['slug','title','client_name','industry','project_type','short_summary','challenge','solution','results','metrics','schema_json','status','published_at']) + ['sections'=>$study->sections->map->only(['section_type','title','subtitle','content','settings','sort_order','is_active'])->all()]; }
}
