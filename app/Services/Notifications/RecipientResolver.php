...
class RecipientResolver
{
    ...
    public function resolve(DomainEvent $event): Collection
    {
        ...
        if (in_array($event->eventKey(), ['crm.lead.created', 'crm.lead.assigned', 'crm.lead.status_changed', 'crm.demo.scheduled', 'crm.demo.google_calendar_synced', 'crm.demo.google_calendar_sync_failed', 'crm.quotation.created', 'crm.quotation.sent', 'crm.quotation.accepted', 'crm.quotation.rejected', 'crm.customer.created'], true)
        ...
        $users = match ($event->eventKey()) {
            ...
            'crm.demo.scheduled', 'crm.demo.google_calendar_synced', 'crm.demo.google_calendar_sync_failed', 'crm.quotation.created', 'crm.quotation.sent', 'crm.quotation.accepted', 'crm.quotation.rejected', 'crm.customer.created' => $this->usersByIds($query, [$payload['assigned_user_id'] ?? null])
