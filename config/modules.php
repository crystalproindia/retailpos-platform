...
return [
    'navigation_search' => [
        'aliases' => [
            ...
            'payment reminder' => ['invoice reminders', 'reminder settings'],
            'invoice reminder' => ['invoice reminders', 'reminder settings'],
            'overdue' => ['invoice reminders', 'outstanding invoices'],
            'outstanding' => ['invoice reminders', 'sales invoices'],
            'due invoice' => ['invoice reminders', 'sales invoices'],
            'collection reminder' => ['invoice reminders'],
            'unpaid bill' => ['invoice reminders', 'sales invoices'],
            'final notice' => ['invoice reminders'],
            'bill reminder' => ['invoice reminders'],
        ],
    ],
    'modules' => [
        'dashboard' => [
        ...
        'crm-customers' => [
            'name' => 'CRM Customers',
            'description' => 'Converted customer accounts and onboarding foundations.',
            'icon' => 'customers',
        ...
        'crm-onboarding' => ['name' => 'Customer Onboarding', 'description' => 'Implementation checklists, documents, training, and go-live tracking.', 'icon' => 'activity', 'route' => 'crm.onboarding.index', 'route_params' => [], 'sort_order' => 125, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $crmRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'crm'],
        'crm-companies' => [
            'name' => 'Companies',
        ...
        'crm-settings' => [
            'name' => 'CRM Settings',
            'description' => 'Lead statuses and sources used across the CRM workspace.',
            'icon' => 'settings',
        ...
        'sales' => [
            'name' => 'Sales',
            'description' => 'Sales invoices and customer-facing payment documents.',
            'icon' => 'sales',
        ...
        'pos' => [
            ...
            'license_key' => 'pos.billing',
            'parent_id' => null,
        ],
        'pos-billing' => ['name' => 'Terminal', 'description' => 'Full-screen cashier billing terminal.', 'icon' => 'pos', 'route' => 'pos.terminal', 'route_params' => [], 'sort_order' => 141, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $posRoles, 'badge' => null, 'license_key' => 'pos.billing', 'parent_id' => 'pos'],
        ...
        'pos-returns' => ['name' => 'Returns', 'description' => 'Post-sale returns, refunds, exchanges, and credit notes.', 'icon' => 'returns', 'route' => 'pos.returns.index', 'route_params' => [], 'sort_order' => 145, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $posRoles, 'permission' => 'pos.returns.view', 'badge' => null, 'license_key' => 'pos.billing', 'parent_id' => 'pos', 'search_aliases' => ['refund', 'exchange', 'credit note']],
        'customers' => [
            'name' => 'Customers',
        ...
        'inventory-decision-dashboard' => [
            ...
            'description' => 'Reorder, movement, aging, valuation, profitability, and transfer decision support.',
            'icon' => 'analytics',
            'route' => 'inventory.intelligence.index',
            'route_params' => [],
            'sort_order' => 202,
            'category' => 'Retail Operations',
            'enabled' => true,
            'visible_in_sidebar' => true,
            'roles' => $managementRoles,
            'badge' => ['label' => 'Smart', 'tone' => 'info'],
            'permission' => 'inventory.decision_dashboard.view',
            'search_aliases' => ['stock intelligence', 'dead stock', 'slow moving', 'fast moving', 'reorder recommendations', 'transfer opportunities'],
            'license_key' => null,
            'parent_id' => 'inventory',
        ],
        'products' => [
        ...
        'inventory-transfers' => ['name' => 'Stock Transfers', 'description' => 'Move stock safely between authorised outlets.', 'icon' => 'inventory', 'route' => 'inventory.transfers.index', 'route_params' => [], 'sort_order' => 556, 'category' => 'Retail Operations', 'enabled' => filter_var(env('MULTI_OUTLET_TRANSFERS_ENABLED', true), FILTER_VALIDATE_BOOL), 'visible_in_sidebar' => true, 'roles' => $inventoryRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'inventory', 'permission' => 'inventory.transfers.view', 'search_aliases' => ['stock transfer', 'transfer stock', 'outlet transfer']],
        'inventory-stock-availability' => ['name' => 'Stock Lookup', 'description' => 'Find available stock across authorised stores and warehouses.', 'icon' => 'search', 'route' => 'inventory.stock.availability', 'route_params' => [], 'sort_order' => 219, 'category' => 'Retail Operations', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'inventory', 'permission' => 'inventory.stock.view', 'search_aliases' => ['stock availability', 'which store', 'barcode lookup']],
        'inventory-stock-counts' => ['name' => 'Stock Counts', 'description' => 'Physical and cycle counts with variance approval.', 'icon' => 'check-square', 'route' => 'inventory.counts.index', 'route_params' => [], 'sort_order' => 222, 'category' => 'Retail Operations', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'inventory', 'permission' => 'inventory.counts.view', 'search_aliases' => ['physical count', 'cycle count', 'stock take']],
        'inventory-traceability' => ['name' => 'Batch, Serial & Expiry', 'description' => 'Batch, serial number, and expiry traceability.', 'icon' => 'barcode', 'route' => 'inventory.traceability.index', 'route_params' => [], 'sort_order' => 223, 'category' => 'Retail Operations', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'inventory', 'permission' => 'inventory.batch.view', 'search_aliases' => ['expiry', 'serial number', 'batch tracking']],
        'inventory-operational-reports' => ['name' => 'Inventory Reports', 'description' => 'Location, transfer, transit, variance, expiry, and ageing reports.', 'icon' => 'reports', 'route' => 'inventory.reports.show', 'route_params' => [], 'sort_order' => 224, 'category' => 'Retail Operations', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'inventory', 'permission' => 'inventory.stock.view', 'search_aliases' => ['stock report', 'inventory ageing', 'in transit report']],
        ...
        'purchase-invoices' => [
            ...
            'description' => 'GRN-matched supplier invoices, verification, approval, and payable tracking.',
            'icon' => 'file-text',
        ...
        'supplier-payments' => [
            ...
            'description' => 'Supplier payment allocation, advances, and protected reversal workflow.',
            'icon' => 'credit-card',
        ...
        'purchase-reports' => [
            ...
            'description' => 'Supplier payables, ageing, purchase register, and input GST snapshots.',
            'icon' => 'analytics',
        ...
        'support' => [
            'name' => 'Support',
            'description' => 'Customer support tickets, SLA commitments, and service history.',
            'icon' => 'support',
            'route' => 'crm.support.tickets.index',
            'route_params' => [],
            'sort_order' => 250,
            'category' => 'CRM',
            'enabled' => true,
        ...
        'workforce' => [
            'name' => 'Workforce',
            'description' => 'Employee profiles, account access, roles, and transparent performance context.',
            'icon' => 'employees',
        ...
        'workforce-dashboard' => [
            'name' => 'Dashboard', 'description' => 'Workforce overview and operational context.', 'icon' => 'dashboard', 'route' => 'workforce.dashboard', 'route_params' => [], 'sort_order' => 401, 'category' => 'People', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'permission' => 'workforce.view', 'badge' => null, 'license_key' => null, 'parent_id' => 'workforce',
        ],
        'workforce-employees' => [
        ...
        'ai-assistant' => [
            'name' => 'AI Assistant',
            'description' => 'Friendly, tenant-scoped business answers and advisory insights.',
            'icon' => 'ai',
            'route' => 'ai.dashboard',
            'route_params' => [],
            'sort_order' => 620,
            ...
            'visible_in_sidebar' => true,
            'roles' => $managementRoles,
            'permission' => 'ai.dashboard.view',
            'badge' => null,
            'license_key' => 'ai.assistant',
            'parent_id' => null,
        ],
        'company' => [
            'name' => 'Company',
        ...
        'branches' => [
            'name' => 'Outlets',
            'description' => 'Manage retail outlets, team assignments, and outlet-level operations.',
            'icon' => 'branches',
            ...
            'search_aliases' => ['branch', 'outlet', 'shop', 'store location'],
            'parent_id' => null,
        ],
        'users' => [
            'name' => 'Users',
            'description' => 'Authentication accounts linked to workforce profiles.',
            'icon' => 'users',
            'route' => 'workforce.users.index',
            'route_params' => [],
            'sort_order' => 403,
            'category' => 'People',
            'enabled' => true,
            ...
            'badge' => null,
            'license_key' => 'users.additional',
            'parent_id' => 'workforce',
        ],
        'roles' => [
            'name' => 'Roles',
            'description' => 'Tenant custom roles with explicit permissions.',
            'icon' => 'roles',
            'route' => 'workforce.roles.index',
            'route_params' => [],
            'sort_order' => 404,
            'category' => 'People',
            'enabled' => true,
        ...
        'invoice-designs' => [
            ...
            'description' => 'Choose the customer-facing invoice layout, print options, and payment QR presentation.',
            'icon' => 'settings',
            'route' => 'sales.invoices.templates.index',
            'route_params' => [],
            'sort_order' => 741,
            'category' => 'Administration',
            'enabled' => true,
        ...
        'sales-document-numbering' => [
            ...
            'description' => 'Manage tenant-scoped invoice and quotation prefixes without changing historical documents.',
            'icon' => 'settings',
            'route' => 'sales.invoices.document-settings.index',
            'route_params' => [],
            'sort_order' => 742,
            'category' => 'Administration',
            'enabled' => true,
            ...
            'parent_id' => 'settings',
            'permission' => 'sales.invoices.update',
            'search_aliases' => ['invoice prefix', 'quotation prefix', 'document number'],
        ],
        'invoice-reminders' => [
            'name' => 'Invoice Reminders',
            'description' => 'Configure secure, tenant-scoped payment reminder timing and customer email wording.',
            'icon' => 'bell',
            'route' => 'sales.invoices.reminders.settings',
            'route_params' => [],
            'sort_order' => 749,
            'category' => 'Administration',
            'enabled' => true,
            ...
            'license_key' => null,
            'parent_id' => 'settings',
            'permission' => 'sales.reminders.manage',
            'search_aliases' => ['reminder settings', 'payment reminder', 'invoice reminder', 'overdue', 'outstanding', 'due invoice', 'collection reminder', 'unpaid bill', 'final notice', 'bill reminder'],
        ],
        'integrations' => [
            'name' => 'Email Integration',
            'description' => 'Manage the configured SMTP delivery connection for the Command Center.',
            'icon' => 'settings',
        ...
        'sales-invoices' => ['name' => 'Sales Invoices', 'description' => 'Issued sales invoices, payments, receipts, and customer-ready documents.', 'icon' => 'sales', 'route' => 'sales.invoices.index', 'route_params' => [], 'sort_order' => 135, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $crmRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'sales'],
        'sales-opportunities' => ['name' => 'Opportunities', 'description' => 'Qualified sales opportunities and pipeline movement.', 'icon' => 'leads', 'route' => 'sales.opportunities.index', 'route_params' => [], 'sort_order' => 136, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $crmRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'sales'],
        'pos-dashboard' => ['name' => 'POS Dashboard', 'description' => 'Daily POS sales, payment split, and cashier performance.', 'icon' => 'dashboard', 'route' => 'pos.dashboard', 'route_params' => [], 'sort_order' => 140, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $posRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'pos'],
        'pos-sales' => ['name' => 'POS Sales', 'description' => 'Completed and voided counter-sale history.', 'icon' => 'sales', 'route' => 'pos.sales.index', 'route_params' => [], 'sort_order' => 144, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $posRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'pos'],
        'pos-registers' => ['name' => 'Registers', 'description' => 'Counter registers and cash session controls.', 'icon' => 'branches', 'route' => 'pos.registers.index', 'route_params' => [], 'sort_order' => 145, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $posRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'pos'],
        'gst-compliance' => ['name' => 'GST & Compliance', 'description' => 'Accountant-reviewable GST documents, reports, exports, and readiness checks.', 'icon' => 'finance', 'route' => 'compliance.gst.dashboard', 'route_params' => [], 'sort_order' => 190, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => null],
        'gst-settings' => ['name' => 'GST Settings', 'description' => 'GST registration, state, series, and accountant-review settings.', 'icon' => 'settings', 'route' => 'compliance.gst.settings.index', 'route_params' => [], 'sort_order' => 191, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $administratorRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'gst-compliance'],
        'gst-notes' => ['name' => 'Credit / Debit Notes', 'description' => 'Draft GST adjustment notes linked to source invoices.', 'icon' => 'sales', 'route' => 'compliance.gst.notes.index', 'route_params' => [], 'sort_order' => 192, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'gst-compliance'],
        'gst-reports' => ['name' => 'GST Reports', 'description' => 'Reviewable outward supply and reconciliation reports.', 'icon' => 'analytics', 'route' => 'compliance.gst.reports.index', 'route_params' => [], 'sort_order' => 193, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'gst-compliance'],
        'gst-exports' => ['name' => 'GST Exports', 'description' => 'Review-before-filing outward-supply exports and history.', 'icon' => 'audit', 'route' => 'compliance.gst.exports.index', 'route_params' => [], 'sort_order' => 194, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'gst-compliance'],
        'gst-periods' => ['name' => 'Return Periods', 'description' => 'GST period review, approval, lock, and reopen controls.', 'icon' => 'calendar', 'route' => 'compliance.gst.periods.index', 'route_params' => [], 'sort_order' => 195, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'gst-compliance'],
        'gst-series' => ['name' => 'Document Series', 'description' => 'GST document-number series history and configuration.', 'icon' => 'audit', 'route' => 'compliance.gst.series.index', 'route_params' => [], 'sort_order' => 196, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'gst-compliance'],
        'gst-eway' => ['name' => 'E-Way Bill Readiness', 'description' => 'Provider-neutral e-way document readiness checks.', 'icon' => 'activity', 'route' => 'compliance.gst.eway.index', 'route_params' => [], 'sort_order' => 197, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'gst-compliance'],
        'gst-guide' => ['name' => 'Filing Guide', 'description' => 'Review checklist and official portal handoff guidance.', 'icon' => 'cms', 'route' => 'compliance.gst.guide', 'route_params' => [], 'sort_order' => 198, 'category' => 'Sales & CRM', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'gst-compliance'],
        'purchase-input-gst' => ['name' => 'Input GST Register', 'description' => 'Approved purchase-invoice input tax snapshots for accountant review.', 'icon' => 'finance', 'route' => 'purchases.reports.input-gst', 'route_params' => [], 'sort_order' => 2384, 'category' => 'Retail Operations', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'purchases'],
        'website-dashboard' => ['name' => 'Website Dashboard', 'description' => 'Website content health and publishing overview.', 'icon' => 'dashboard', 'route' => 'website.dashboard', 'route_params' => [], 'sort_order' => 5261, 'category' => 'Content Management', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'website-cms'],
        'website-case-studies' => ['name' => 'Case Studies', 'description' => 'Customer case study publishing and preview workflow.', 'icon' => 'blog', 'route' => 'website.case-studies.index', 'route_params' => [], 'sort_order' => 5262, 'category' => 'Content Management', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'website-cms'],
        'website-media' => ['name' => 'Media Library', 'description' => 'Website media upload and library management.', 'icon' => 'folders', 'route' => 'website.media.index', 'route_params' => [], 'sort_order' => 5263, 'category' => 'Content Management', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $managementRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'website-cms'],
        'website-import' => ['name' => 'Content Import', 'description' => 'Validated CMS content manifest import workflow.', 'icon' => 'audit', 'route' => 'website.import.index', 'route_params' => [], 'sort_order' => 5264, 'category' => 'Content Management', 'enabled' => true, 'visible_in_sidebar' => true, 'roles' => $administratorRoles, 'badge' => null, 'license_key' => null, 'parent_id' => 'website-cms'],
        'operations' => [
        ...
        'notification-automation' => [
            ...
            'description' => 'Company alert rules, delivery channels, and owner summaries.',
            'icon' => 'settings',
            'route' => 'notifications.automation.edit',
            'route_params' => [],
            'sort_order' => 747,
            'category' => 'System & Operations',
            'enabled' => true,
