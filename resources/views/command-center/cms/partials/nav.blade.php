@php
    $links = [
        ...
        ['label' => 'Website Content', 'route' => 'cms.content.index'],
        ['label' => 'Content Navigation', 'route' => 'cms.content.navigation.index'],
        ['label' => 'Content Footer', 'route' => 'cms.content.footer.index'],
