...
@section('content')
    ...
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        <section class="rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <form method="POST" action="{{ $isReschedule ? route('crm.demos.reschedule', $demo) : route('crm.demos.store', $lead) }}" class="p-5">
                @csrf
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select id="meeting_mode" name="meeting_mode" required class="mt-2 block w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-950 shadow-sm outline-none focus:border-slate-950 focus:ring-4 focus:ring-slate-200 dark:border-slate-700 dark:bg-slate-950 dark:text-white dark:focus:ring-slate-800">
