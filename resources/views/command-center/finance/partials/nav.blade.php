<nav class="mb-6 flex gap-2 overflow-x-auto pb-1" aria-label="Finance navigation">
    @foreach ([['Receivables', 'finance.receivables.index', 'finance.receivables.view'], ['Payables', 'finance.payables.index', 'finance.payables.view'], ['Reconciliation', 'finance.reconciliation.index', 'finance.reconciliation.manage']] as [$label, $route, $permission])
        @can($permission)
