                ...
                <div class="grid gap-5 lg:grid-cols-2">
                    ...
                    <section class="rounded-lg border border-slate-200 p-5 dark:border-slate-800" aria-labelledby="automation-owner">
                        ...
                        <div class="mt-5 space-y-4">
                            ...
                            <div class="rounded-lg border border-emerald-200 bg-emerald-50/60 p-3 dark:border-emerald-900 dark:bg-emerald-950/20"><p class="text-xs font-semibold uppercase text-emerald-800 dark:text-emerald-200">Monthly finance</p><div class="mt-3 space-y-3"><label class="flex items-start gap-3"><input type="checkbox" name="monthly_expense_summary_enabled" value="1" @checked(old('monthly_expense_summary_enabled', $setting->monthly_expense_summary_enabled)) class="{{ $toggle }}"><span><span class="block text-sm font-semibold text-slate-800 dark:text-slate-100">Monthly expense summary</span><span class="mt-1 block text-xs text-slate-600 dark:text-slate-300">A low-noise summary of operating expenses, net sales, and the largest operating expense category.</span></span></label><label class="flex items-start gap-3"><input type="checkbox" name="monthly_profit_and_loss_summary_enabled" value="1" @checked(old('monthly_profit_and_loss_summary_enabled', $setting->monthly_profit_and_loss_summary_enabled)) class="{{ $toggle }}"><span><span class="block text-sm font-semibold text-slate-800 dark:text-slate-100">Monthly profit &amp; loss summary</span><span class="mt-1 block text-xs text-slate-600 dark:text-slate-300">A consolidated, administrator-only P&amp;L summary for the completed month. Off by default.</span></span></label></div></div>
                            <div class="grid gap-4 sm:grid-cols-2">
