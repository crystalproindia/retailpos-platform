<table class="thermal-totals" role="presentation"><tbody>
    <tr><td>Taxable</td><td class="right">{{ number_format((float) $invoice->taxable_total, 2) }}</td></tr>
    ...
    <tr><td>GST</td><td class="right">{{ number_format((float) $invoice->tax_total, 2) }}</td></tr>
