...
use App\Http\Controllers\CommandCenter\Finance\ExpenseReceiptController;
use App\Http\Controllers\CommandCenter\Finance\ExpenseController;
use App\Http\Controllers\CommandCenter\Finance\ExpenseCategoryController;
use App\Http\Controllers\CommandCenter\Finance\ProfitAndLossController;
...
Route::middleware(['auth', 'workforce.account.active'])->group(function (): void {
    ...
    Route::middleware('role:administrator,manager')->prefix('finance')->name('finance.')->group(function (): void {
        Route::get('profit-and-loss', [ProfitAndLossController::class, 'index'])->middleware('can:finance.profit_and_loss.view')->name('profit-and-loss.index');
        Route::get('profit-and-loss.csv', [ProfitAndLossController::class, 'csv'])->middleware('can:finance.profit_and_loss.export')->name('profit-and-loss.csv');
        Route::get('profit-and-loss.pdf', [ProfitAndLossController::class, 'pdf'])->middleware('can:finance.profit_and_loss.export')->name('profit-and-loss.pdf');
        Route::get('expense-categories', [ExpenseCategoryController::class, 'index'])->middleware('can:finance.expense_categories.manage')->name('expense-categories.index');
        Route::get('expense-categories/create', [ExpenseCategoryController::class, 'create'])->middleware('can:finance.expense_categories.manage')->name('expense-categories.create');
        Route::post('expense-categories', [ExpenseCategoryController::class, 'store'])->middleware('can:finance.expense_categories.manage')->name('expense-categories.store');
        Route::get('expense-categories/{expenseCategory}/edit', [ExpenseCategoryController::class, 'edit'])->middleware('can:finance.expense_categories.manage')->name('expense-categories.edit');
        Route::put('expense-categories/{expenseCategory}', [ExpenseCategoryController::class, 'update'])->middleware('can:finance.expense_categories.manage')->name('expense-categories.update');
        Route::get('expenses', [ExpenseController::class, 'index'])->middleware('can:finance.expenses.view')->name('expenses.index');
        Route::get('expenses.csv', [ExpenseController::class, 'csv'])->middleware('can:finance.profit_and_loss.export')->name('expenses.csv');
        Route::get('expenses/create', [ExpenseController::class, 'create'])->middleware('can:finance.expenses.create')->name('expenses.create');
        Route::post('expenses', [ExpenseController::class, 'store'])->middleware('can:finance.expenses.create')->name('expenses.store');
        Route::get('expenses/{expense}', [ExpenseController::class, 'show'])->middleware('can:finance.expenses.view')->name('expenses.show');
        Route::post('expenses/{expense}/post', [ExpenseController::class, 'post'])->middleware('can:finance.expenses.post')->name('expenses.post');
        Route::post('expenses/{expense}/reverse', [ExpenseController::class, 'reverse'])->middleware('can:finance.expenses.reverse')->name('expenses.reverse');
        Route::get('expenses/{expense}/receipt', [ExpenseReceiptController::class, 'show'])->middleware('can:finance.expenses.view')->name('expenses.receipt');
